              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a>综合
                    <span 
                      class="iconfont" 
                      :class="{ 'icon-UP': isAsc, 'icon-jiantou2': isDesc }"></span>
                  </a>
                </li>
...
<script>
  ...
  export default {
    ...
    computed:{
      //mapGetters里面的写法：传递的====数组====，因为getters计算是没有划分模块【home,search】
